            ...
            dbc.Row(
                dbc.Col(
                    html.H3("Objetivos del Proyecto",
                            className="fw-bold pt-3 mb-1", style={"color": "#ffffff"}),
                    width=12,
                )
            ),
            dbc.Row(
                                        ...
                                        dbc.Col(
                                            [
                                                html.H5("Objetivo General",
                                                        className="fw-bold mb-2", style={"color": "#ffffff"}),
                                                html.P(
                                                    """
            ...
            dbc.Row(
                dbc.Col(
                    html.H5("📌 Objetivos Específicos",
                            className="fw-semibold mb-3", style={"color": "#ffffff"}),
                    width=12,
                )
            ),
            dbc.Row(
        ...
        dbc.Card(
            dbc.CardBody(
                [
                    ...
                    html.H6(title, className="fw-bold mb-2 mt-1", style={"color": "#ffffff"}),
