                        ...
                        dbc.CardBody(
                            [
                                html.H5("📌 Interpretación Conjunta ADF + KPSS",
                                        className="fw-semibold mb-2", style={"color": "#000000"}),
...
def _test_card(titulo: str, result: dict, bg: str):
    ...
    return dbc.Col(
        dbc.Card(
            dbc.CardBody(
                [
                    html.H6(f"{icono} {titulo}", className="fw-bold mb-3", style={"color": "#000000"}),
                    dbc.Row(
                        [
                            dbc.Col([
        ...
        dbc.Card(
            dbc.CardBody(
                [
                    ...
                    html.H6(titulo, className="fw-bold text-center mb-2", style={"color": "#000000"}),
