...
def layout():
    return dbc.Container([
        ...
        dbc.Row(dbc.Col(html.H3("Conclusiones",
            className="fw-bold pt-3 mb-1", style={"color": "#000000"}), width=12)),
        ...
        dbc.Row(dbc.Col(dbc.Card(dbc.CardBody([
            html.P("""El presente trabajo realizó un análisis exploratorio completo de las series históricas
                   ...
                   className="mb-0",
                   style={"color": "#000000", "font-size": "1rem", "line-height": "1.85"}),
        ...
        dbc.Row(dbc.Col(html.H5("Conclusiones Principales",
            className="fw-semibold mb-3", style={"color": "#000000", "font-size": "1.1rem"}), width=12)),
        ...
        dbc.Row([
            dbc.Col(dbc.Card(dbc.CardBody([
                ...
                html.H6(titulo, className="fw-bold mb-2 mt-1",
                        style={"color": "#000000", "font-size": "0.95rem"}),
                html.P(desc, className="mb-0",
                       style={"color": "#000000", "font-size": "0.95rem", "line-height": "1.8"}),
        ...
        dbc.Row(dbc.Col(html.H5("Recomendaciones",
            className="fw-semibold mb-3 mt-2", style={"color": "#000000", "font-size": "1.1rem"}), width=12)),
        ...
        dbc.Row(dbc.Col(dbc.Card(dbc.CardBody([
            dbc.Row([
                dbc.Col([
                    ...
                    html.Ul([
                        html.Li(item, style={"color": "#000000", "font-size": "0.95rem",
           ...
           style={"background": "#ffffff", "border-radius": "12px"}), width=12)),
        ...
        dbc.Row(dbc.Col(dbc.Card(dbc.CardBody(
            html.Div([
                html.Span(label, className="badge me-2 mb-2 px-3 py-2",
                          style={"background": "#ffffff", "color": color, "font-size": "0.88rem",
        ...
        ), className="border-0", style={"background": "#ffffff", "border-radius": "10px"}), width=12)),
